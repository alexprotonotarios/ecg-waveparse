...
images, tensors and alternate runs remain disposable. The first baseline's
entire retained eight-case evidence bundle was 50,836,731 logical bytes; the
added permanent cost depends on exported sample/uncertainty counts.
...
the CSV and source evidence. See [SCORING-CONTRACT.md](SCORING-CONTRACT.md).
